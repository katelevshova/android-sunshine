...
public class TestWeatherProvider extends AndroidTestCase
{
	...
	{
		// content://com.hally.sunshine/weather/
		String type = mContext.getContentResolver().getType(WeatherEntry.CONTENT_URI);
		// vnd.android.cursor.dir/com.hally.sunshine/weather
		assertEquals("Error: the WeatherEntry CONTENT_URI should return WeatherEntry.CONTENT_TYPE",
				WeatherEntry.CONTENT_TYPE, type);

		String testLocation = "94074";
		// content://com.hally.sunshine/weather/94074
		...
		// content://com.hally.sunshine/weather/94074/20140612
		type = mContext.getContentResolver().getType(
				WeatherEntry.buildWeatherLocationWithDate(testLocation, testDate));
		// vnd.android.cursor.item/com.hally.sunshine/weather/1419120000
		assertEquals(
		...
		// content://com.hally.sunshine/location/
		type = mContext.getContentResolver().getType(LocationEntry.CONTENT_URI);
		// vnd.android.cursor.dir/com.hally.sunshine/location
		assertEquals(
	...
	public void testInsertReadProvider()
	{
		...
		Uri locationUri =
				mContext.getContentResolver().insert(LocationEntry.CONTENT_URI, testValues);
	...
	/**
	 * Make sure we can still delete after adding/updating stuff Student: Uncomment this test after
	 * you have completed writing the delete functionality in your provider.  It relies on
	 * insertions with testInsertReadProvider, so insert and query functionality must also be
	...
	static ContentValues[] createBulkInsertWeatherValues(long locationRowId)
	{
		...
		for (int i = 0; i < BULK_INSERT_RECORDS_TO_INSERT;
			 i++, currentTestDate += millisecondsInADay)
		{
	...
	/**
	 * Student: Uncomment this test after you have completed writing the BulkInsert functionality in
	 * your provider.  Note that this test will work with the built-in (default) provider
	...
	public void testBulkInsert()
	{
		...
		{
			TestUtilities
					.validateCurrentRecord("testBulkInsert.  Error validating WeatherEntry " + i,
