...
public class WeatherContract
{
	...
	// is guaranted to be unique on the device
	public static final String CONTENT_AUTHORITY = "com.hally.sunshine";
	...
	public static final class WeatherEntry implements BaseColumns
	{
		...
		public static Uri buildWeatherLocation(String locationStr)
		{
			return CONTENT_URI.buildUpon().appendPath(locationStr).build();
		}
		...
		public static Uri buildWeatherLocationWithStartDate(String locationSetting, long startDate)
		{
			...
			return CONTENT_URI.buildUpon().appendPath(locationSetting).appendQueryParameter
					(COLUMN_DATE, Long.toString(normalizeDate)).build();
		}

		public static Uri buildWeatherLocationWithDate(String locationSetting, long date)
		{
			return CONTENT_URI.buildUpon().appendPath(locationSetting).appendPath(Long.toString
