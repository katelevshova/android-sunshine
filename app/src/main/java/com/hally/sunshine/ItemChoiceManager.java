...
public class ItemChoiceManager
{
	...
	public void onClick(RecyclerView.ViewHolder vh)
	{
		...
		{
			TraceUtil.logD(LOG_TAG, "onClick", "Unable to Set Item State");
			return;
		}
	...
	/**
	 * Defines the choice behavior for the RecyclerView. By default, RecyclerViewChoiceMode does not
	 * have any choice behavior (AbsListView.CHOICE_MODE_NONE). By setting the choiceMode to
	 * AbsListView.CHOICE_MODE_SINGLE, the RecyclerView allows up to one item to  be in a chosen
	 * state.
	 *
