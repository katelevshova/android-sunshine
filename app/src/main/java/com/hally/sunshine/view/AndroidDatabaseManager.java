...
import com.hally.sunshine.data.WeatherDbHelper;
 ...
 * Allows to view and manage your android app database
 */
public class AndroidDatabaseManager extends Activity implements OnItemClickListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		LinearLayout.LayoutParams secondrowlp =
		...
		submitQuery.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v)
			{
				...
				if (Message2.getString(0).equalsIgnoreCase("Success"))
				{
					...
					if (c4 != null)
					{
						tvmessage.setText("Queru Executed successfully.Number of rows returned :" +
								c4.getCount());
						if (c4.getCount() > 0)
						{
		...
		ArrayAdapter<String> tablenamesadapter =
				new ArrayAdapter<String>(AndroidDatabaseManager.this,
				...
				if (pos != 0)
				{
					...
					if (c2 != null)
					{
						...
						spinnertable
								.setOnItemSelectedListener((new AdapterView.OnItemSelectedListener()
								{
															   ...
															   long id)
									{
										...
										if (spinnertable.getSelectedItem().toString()
												...
												.equals("Add row to this table"))
										{
											...
											final LinkedList<TextView> addnewrownames =
													new LinkedList<TextView>();
											final LinkedList<EditText> addnewrowvalues =
													new LinkedList<EditText>();
											final ScrollView addrowsv =
													new ScrollView(AndroidDatabaseManager.this);
											Cursor c4 = indexInfo.maincursor;
											if (indexInfo.isEmpty)
											{
												getcolumnnames();
												for (int i = 0;
													 i < indexInfo.emptytablecolumnnames.size();
													 i++)
												{
													String cname =
															indexInfo.emptytablecolumnnames.get(i);
													TextView tv =
											...
											final RelativeLayout addnewlayout =
													new RelativeLayout(AndroidDatabaseManager.this);
											RelativeLayout.LayoutParams addnewparams =
											...
											for (int i = 0; i < addnewrownames.size(); i++)
											{
												...
												final LinearLayout ll = new LinearLayout(
														AndroidDatabaseManager.this);
												LinearLayout.LayoutParams tvl =
														new LinearLayout.LayoutParams(0, 100);
												tvl.weight = 1;
												ll.addView(tv, tvl);
												ll.addView(et, tvl);
												ll.setId(lid);
						...
						for (int k = 0; k < c2.getColumnCount(); k++)
						{
							...
							final TextView tableheadercolums =
									new TextView(getApplicationContext());
	...
	public void updateDeletePopup(int row)
	{
		...
		LinearLayout.LayoutParams paramcrudtext =
		...
		RelativeLayout.LayoutParams rlcrudparam =
									...
									new DialogInterface.OnClickListener()
									{
										...
										public void onClick(DialogInterface dialog, int which)
										{
											...
											String spinner_value =
													crud_dropdown.getSelectedItem().toString();
											...
											if (spinner_value.equalsIgnoreCase("Update this row"))
											{
												indexInfo.index = 10;
												String Query3 =
														"UPDATE " + indexInfo.table_name + " SET ";
												...
												else
												{
													...
													tvmessage
															.setText("Error:" + tempc.getString(0));
												}
											}
											...
											if (spinner_value.equalsIgnoreCase("Delete this row"))
											{
												...
												indexInfo.index = 10;
												String Query5 =
														"DELETE FROM " + indexInfo.table_name +
																" WHERE ";
												...
												if (tempc.getString(0).equalsIgnoreCase("Success"))
												{
													tvmessage.setBackgroundColor(
															Color.parseColor("#2ecc71"));
													tvmessage.setText("Row deleted from " +
															indexInfo.table_name + " table");
													refreshTable(0);
												}
												else
												{
